...
braces vs do/end, etc are all ignored. Making this totally rad.}
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "bin/flay", "lib/flay.rb", "lib/flay_erb.rb", "lib/flay_task.rb", "lib/gauntlet_flay.rb", "test/test_flay.rb", ".gemtest"]
